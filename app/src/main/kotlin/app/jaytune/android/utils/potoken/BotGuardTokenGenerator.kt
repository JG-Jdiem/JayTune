...
package app.jaytune.android.utils.potoken
...
private object Timber {
    ...
    class Tree(
        ...
        fun w(error: Throwable, message: String) = Log.w(tag, message, error)
        fun e(message: String) = Log.e(tag, message)
        fun e(error: Throwable, message: String) = Log.e(tag, message, error)
    }
}
